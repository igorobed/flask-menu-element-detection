# Почему 6 и 9 так работают и что будет, если поправить код?
import cv2
import easyocr
import numpy as np
import time
...
show_img(menu_box_img)
cv2.imwrite("tests\\test_imgs\\img_12_res.jpg", menu_box_img)
...
# в данный момент в голову приходит самый простой вариант - хранить две полученные области и если одна не
# подошла, попробовать предложить вторую без повторной обработки изображения